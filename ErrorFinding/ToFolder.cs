...
namespace ErrorFinding
{
    public class ToFolder
    {
        public void ToManagementFile()
        {
            ...
            List<ErrorList> listErrorManagement = errorSynchronization.compareErrorsListVElif(errorList.GetErrorListApi(),errorList.GetErrorListManagement("https://raw.githubusercontent.com/xyztek/CrowdFundingManagement/master/src/lang/errorCodes/tr_TR.js"));
