module.exports = { 
Api_UnhandledException: "Uncaught exception! See inner errors for details, if any.",
Api_InputModelValidation: "Error validating input model! See inner errors for details, if any.",
...
Core_Authentication_CorruptedSignKey: "Provided token encryption key differs from server encryption key!",
Core_Authentication_RefreshNotAllowed: "Authentication token refresh is not allowed!",
Core_CoreExtensions_Aws_GeneralAwsError: "An AWS error occurred! See inner errors for details, if any.",
...
Core_CoreExtensions_Storage_FtpStorage_UploadFail: "Upload operation is failed!",
Core_CoreExtensions_Storage_FtpStorage_DownloadFail: "Download operation is failed!",
...
Core_Operation_ReflectingOperationDidNotReflect: "Reflecting operation must reflect a TReflecting to a TReflected!",
Core_Operation_ResultReturningOperationDidNotReturnResult: "Result returning operation must return a TValue result!",
Core_Operation_OperationOutputTypeDidNotSet: "An OperationOutputType must be set to the operation to determine IOperationOutput!",
Core_Operation_NotFound: "Value not found.",
Core_Result_CombinedError: "Multiple errors are occurred. See inner errors for details, if any.",
Domain_Validation: "Error validating value! See inner errors for details, if any.",
Domain_Purge: "Error purging entity! See inner errors for details, if any",
Domain_Authentication: "Generic authentication error! See inner errors for details, if any.",
Domain_CrowdFunding_Account_InsufficientLimit: "Insufficient account limit!",
Domain_CrowdFunding_Account_ExceedsMaximumIncomeStatement: "Maximum income statement exceeding!",
Domain_CrowdFunding_Account_NotOwnedInvestment: "Account does not hold ownership of the investment!",
Domain_CrowdFunding_Account_NotCorporateIdentity: "You need to hold a 'Corporate Identity' to complete this action!",
Domain_CrowdFunding_Account_CantStateSameQualification: "You can not state same qualification state!",
Domain_CrowdFunding_Asset_RequiredQualifiedInvestorInvestmentNotMet: "Minimum required qualified investor investment amount is not ensured!",
Domain_CrowdFunding_Asset_InvalidCommittedInvestmentData: "Data corruption on Committed investments!",
Domain_CrowdFunding_Asset_NotFound: "Asset Not Found!",
Domain_CrowdFunding_Asset_EquityRegistration_RegistrationNotCompleted: "Equity Registration not completed!",
Domain_CrowdFunding_Bulletin_AlreadyRegistered: "E-Mail address is already in bullet-in lists!",
Domain_CrowdFunding_Bulletin_NotFound: "E-Mail address is not found in bullet-in lists!",
Domain_CrowdFunding_Common_InvalidAnnouncementUrl: "Paya Dayalı Kitle Fonlaması Tebliği linki bulunamadı. Lütfen sistem yöneticinize başvurunuz.",
Domain_CrowdFunding_Investment_StatusViolation: "Investment is in a different state!",
Domain_CrowdFunding_Investment_RefundValidUntilDateIsInPast: "Refund valid date is in past!",
Domain_CrowdFunding_Investment_RefundValidUntilDateIsNotSet: "Refund valid date is not set!",
Domain_CrowdFunding_Investment_NotFound: "Investment not found!",
Domain_CrowdFunding_Investment_PaymentMethodViolation: "Payment method is incorrect!",
Domain_CrowdFunding_Investment_CanNotRefundFinishedProject: "Related project is finished!",
Domain_CrowdFunding_Investment_RefundWindowClosed: "Refund windows is closed!",
Domain_CrowdFunding_Investment_RefundAlreadyRequested: "Refund is already requested!",
Domain_CrowdFunding_Investment_CanNotApproveCancelOrRefundRequested: "Operation not permitted. A cancellation or a refund is already requested!",
Domain_CrowdFunding_Investment_CanNotModifyTransferDate: "Transfer date can not be modified!",
Domain_CrowdFunding_Investment_InvalidTransferDate: "Transfer date is not valid!",
Domain_CrowdFunding_Investment_AlreadyHasCardPaymentErrorJobInfo: "Already has credit card payment error check scheduled job info record!",
...
Domain_CrowdFunding_Project_FinishDateIsEmpty: "Funding Finish Datetime can not be empty!",
